...
public class UndoButtonView extends PicButtonView {

    public UndoButtonView(ViewListener viewListener, RectF bounds, int color1, int color2, int color3, Bitmap[] innerImages, Context context, Paint paint) {
    ...
    public void onButtonPressed() {
        if (PuzzleSelectionView.INSTANCE.getSelectedPuzzle().isUndoable()) {
            PuzzleSelectionView.INSTANCE.getSelectedPuzzle().setUndo();
        }

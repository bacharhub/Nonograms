...
public class TouchButtonView extends TitlePicButtonView {

    public TouchButtonView(ViewListener viewListener, String description, RectF bounds, int color1, int color2, int color3, Bitmap[] innerImages, Context context, Paint paint) {
    ...
    public void onButtonPressed() {
        ((OptionsViewListener)viewListener).onTouchButtonPressed();
    }
}

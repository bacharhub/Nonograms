...
public class MultiTouchQuestionButtonView extends MultiTouchButtonView {

    public MultiTouchQuestionButtonView(ViewListener viewListener, RectF bounds, int color1, int color2, int color3, Bitmap[] innerImages, Context context, Paint paint) {

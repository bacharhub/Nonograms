...
public class LargePuzzleButtonView extends LabeledPicButtonView {

    public LargePuzzleButtonView(MenuViewListener menuViewListener, RectF bounds, String description, int color1, int color2, int color3, Bitmap[] innerImages, Context context, Paint paint) {
    ...
    public void onButtonPressed() {
        ((MenuViewListener)viewListener).onLargePuzzleButtonPressed();
    }
}
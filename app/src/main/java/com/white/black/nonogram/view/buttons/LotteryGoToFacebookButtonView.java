...
public class LotteryGoToFacebookButtonView extends LabeledHorizontalButtonView {

    public LotteryGoToFacebookButtonView(ViewListener viewListener, String description, RectF bounds, int color1, int color2, int color3, Bitmap[] innerImages, Context context, Paint paint) {
    ...
    protected void drawText(Canvas canvas, Paint paint, RectF superBounds) {
        paint.setTextSize(ApplicationSettings.INSTANCE.getScreenWidth() / 24);
    ...
    public void onButtonPressed() {
        ((LotteryViewListener)viewListener).onGoToFacebookButtonPressed();
    }
}

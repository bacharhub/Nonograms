...
public class SlideDownButtonView extends MultiTouchButtonView {

    public SlideDownButtonView(ViewListener viewListener, RectF bounds, int color1, int color2, int color3, Bitmap[] innerImages, Context context, Paint paint) {
